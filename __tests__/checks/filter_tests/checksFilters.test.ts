...
describe("filterChecksWithMatchingNameAndAppId", () => {
  it("should return checks with matching name and app id", () => {
    let input: ICheckInput[] = [
      { app_id: 1, name: "check1" },
      { app_id: 2, name: "check2" },
    ];
    let expected = {
      filteredChecks: [checksData[1], checksData[2]],
      missingChecks: [],
    };

    expect(
      filterChecksWithMatchingNameAndAppId(checksData, input)
  ...
  it("should return missing checks if checks with matching name and app id are not found", () => {
    let input: ICheckInput[] = [
      { app_id: 1, name: "check1" },
      { app_id: 2, name: "check3" },
    ];
    let expected = {
      filteredChecks: [checksData[1]],
      missingChecks: [{ app_id: 2, name: "check3" }],
    };
  });
});
...
describe("returnChecksWithMatchingNameAndAppId", () => {
  it("should return checks with matching name and app id", () => {
    ...
    expect(
      returnChecksWithMatchingNameAndAppId(checksData, input.name, input.app_id)
    ).toStrictEqual(expected);
  });
...
describe("checkOneOfTheChecksInputIsEmpty", () => {
  ...
  it("should throw an error if both of the input checks are not empty", () => {
    ...
    let input2: ICheckInput[] = [
      { app_id: 3, name: "check3" },
      { app_id: 4, name: "check4" },
    ];
...
describe("removeDuplicateEntries", () => {
  it("it should return check inputs as is if no duplicates exist", () => {
    ...
    expect(removeDuplicateEntriesChecksInputsFromSelf(input)).toStrictEqual(
      input
    );
  });
  ...
  it("it should remove duplicate entries", () => {
    ...
    let expectedOutput: ICheckInput[] = [
      { app_id: 1, name: "check1" },
      { app_id: 2, name: "check2" },
    ];
    expect(removeDuplicateEntriesChecksInputsFromSelf(input)).toStrictEqual(
...
describe("removeChecksWithMatchingNameAndAppId", () => {
  it("should remove checks with matching name and app id", () => {
    ...
    expect(
      removeChecksWithMatchingNameAndAppId(checksData, input)
...
describe("removeDuplicateChecksEntriesFromSelf", () => {
  ...
  it("it should remove duplicate entries", () => {
    ...
    expect(removeDuplicateChecksEntriesFromSelf(input)).toStrictEqual(
      expectedOutput
    );
  });
});
